...
| --- | --- | --- |
| **Best** | One stream per channel, best first | `https://Missel752.github.io/iptv/playlists/best.m3u` |
| **Working only** | Only streams that passed the last health check | `https://Missel752.github.io/iptv/playlists/online.m3u` |
| **Everything** | Every stream, including backups | `https://Missel752.github.io/iptv/playlists/index.m3u` |
| **EPG** | Programme guide for every linked channel | `https://Missel752.github.io/iptv/epg/guide.xml.gz` |
